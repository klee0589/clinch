...
const mockGym = {
  ...
  description: 'Premier training facility with authentic Thai equipment and professional coaching staff. We pride ourselves on maintaining the highest standards of Muay Thai tradition while providing modern training facilities. Our gym has produced multiple champions and welcomes students of all skill levels.',
  address: '123 Main St',
  city: 'Los Angeles',
  state: 'CA',
  zipCode: '90012',
  ...
  photos: [],
  trainers: [
    { id: '1', name: 'John "The Clincher" Smith', specialties: ['Traditional', 'Golden Age'] },
    { id: '2', name: 'Sarah "Lightning" Chen', specialties: ['Dutch', 'Modern'] },
  ],
};
...
const mockReviews = [
  {
    id: '1',
    rating: 5,
    comment: 'Amazing gym with great equipment and atmosphere. The staff is very welcoming and professional.',
    reviewerName: 'Alex M.',
    date: '1 week ago',
  },
  {
    id: '2',
    rating: 5,
    comment: 'Best Muay Thai gym in LA! Great trainers and a supportive community.',
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-8">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h1 className="text-3xl font-bold text-white mb-2">{mockGym.name}</h1>
                  <p className="text-zinc-400 mb-3">
                    {mockGym.address}, {mockGym.city}, {mockGym.state} {mockGym.zipCode}
                  </p>
                  <div className="flex items-center gap-1 text-yellow-500">
                    <span>⭐</span>
                    <span className="font-medium text-white">{mockGym.averageRating}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-8">
              ...
              <p className="text-zinc-300 leading-relaxed">{mockGym.description}</p>
            </div>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-8">
              ...
              <div className="space-y-3">
                {schedule.map((item) => (
                  <div key={item.day} className="flex justify-between text-zinc-300">
                    <span>{item.day}</span>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-8">
              <h2 className="text-2xl font-bold text-white mb-4">Trainers at this Gym</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6 sticky top-6">
              ...
              <div className="mb-6 p-4 bg-zinc-900 rounded-lg">
                ...
                <div className="text-xl font-bold text-white">${mockGym.dropInFee}</div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-zinc-700 text-center">
                <div className="text-sm text-zinc-400 mb-2">First class free!</div>
                <div className="text-xs text-zinc-500">No commitment required</div>
              </div>
            </div>
          </div>
        </div>
