...
async function testConnection() {
  ...
  if (!process.env.DATABASE_URL) {
    ...
    console.log(
      "   Format: postgresql://postgres:[PASSWORD]@db.zzxfdjoxddjmzhhytxzx.supabase.co:5432/postgres",
    );
    process.exit(1);
  }
  ...
  if (process.env.DATABASE_URL.includes("[YOUR-PASSWORD]")) {
    ...
    console.log(
      "   Get it from: https://supabase.com/dashboard/project/zzxfdjoxddjmzhhytxzx/settings/database",
    );
    process.exit(1);
  }
